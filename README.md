...
<h1 align=center >Contact Tracker</h1>

<p align=center >Contact Tracker is a terminal run python application that allows users to store details i.e. cell phone numbers and email address, 4th September 2021</p>
...
* To add new contact details - add your information
* Store my existing details

## Specifications
| Behaviour | Input | Output |
| :---------------- | :---------------: | ------------------: |
| Display codes for navigation | **In terminal: $./run.py** | Hello Welcome to your contact list. What is your name? |
| Display prompt for creating a new contact | **Enter: cc** | Enter your first name, last name, phone number and email address |
| Display a list of contacts | **Enter: dc** | Prints a list of saved contacts |
...
* In your terminal:
        ...
        $ git clone https://github.com/freestyletear/contact_tracker.git
        $ cd contact-list
...
- Fork the repo reach out to (https://github.com/freestyletear/contact_tracker/fork)
...
* To run the tests for the class file:
        ...
        $ python3 contact_test.py

## Known Bugs / Feature Request
* Copy function not fully functional
* If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/freestyletear/contact_tracker/issues/new) by including your search query and the expected result.
...
[link-1]: https://raw.githubusercontent.com/freestyletear/contact_tracker/master/LICENSE
